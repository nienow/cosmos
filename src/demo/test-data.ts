export const DATA_ONE = ['Hello World One', 'plain'];
export const DATA_TWO = ['Hello World Two', 'com.dylanonelson.sn-scratch-editor'];
...
}), 'randombits.excalidraw'];

export const DATA_NEW = ['', null];
